...
(function ($) {
    ...
    $.fn.oembed.providers = [
        ...
        new $.fn.oembed.OEmbedProvider("googleviews", "rich", ["google\\.com\/maps\/embed\\?.+"], "https://www.google.com/maps/embed?$1", {templateRegex: /.*google\.com\/maps\/embed\?(.+)/, embedtag: {tag: 'iframe', width: 480, height: 360 }, nocache: 1}),
